...
main:
	...
	mov pwm, #50 ; Example PWM value to test
	mov pwm2, #20
	clr s_flag  ; Ensure flag is cleared initially

Update_Display:
	; Wait for s_flag to indicate 1 second has passed
	jnb s_flag, Update_Display

	; Clear s_flag and update LCD with new `seconds` value
	clr s_flag
	
	Set_Cursor(1,2)
	Display_BCD(seconds)  ; Update LCD with current seconds count

	ljmp Update_Display  ; Loop to continuously update display
